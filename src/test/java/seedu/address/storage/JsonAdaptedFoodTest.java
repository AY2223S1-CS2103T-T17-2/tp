...
public class JsonAdaptedFoodTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedFood person =
                new JsonAdaptedFood(INVALID_NAME, VALID_CALORIE, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedFood person = new JsonAdaptedFood(null, VALID_CALORIE, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedFood person =
                new JsonAdaptedFood(VALID_NAME, VALID_CALORIE, invalidTags);
