...
/**
 * Deletes a food item identified using it's displayed index from the address book.
 */
public class DeleteCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Deletes the food item identified by the index number used in the displayed person list.\n"
